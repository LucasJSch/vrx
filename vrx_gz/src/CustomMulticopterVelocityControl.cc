...
#include "CustomMulticopterVelocityControl.hh"
...
//////////////////////////////////////////////////
void CustomMulticopterVelocityControl::Configure(const Entity &_entity,
    ...
    EventManager &/*_eventMgr*/)
{
  ...
  {
    gzerr << "CustomMulticopterVelocityControl plugin should be attached to a model "
  ...
  {
    gzerr << "Please specify velocityGain for CustomMulticopterVelocityControl.\n";
    return;
  }
  ...
  {
    gzerr << "Please specify attitudeGain for CustomMulticopterVelocityControl.\n";
    return;
  }
  ...
  {
    gzerr << "Please specify angularRateGain CustomMulticopterVelocityControl.\n";
    return;
  }
  ...
  this->node.Subscribe(enableTopic, &CustomMulticopterVelocityControl::OnEnable,
                       this);
  gzmsg << "CustomMulticopterVelocityControl subscribing to Boolean messages on ["
...
//////////////////////////////////////////////////
math::Inertiald CustomMulticopterVelocityControl::VehicleInertial(
...
//////////////////////////////////////////////////
void CustomMulticopterVelocityControl::PreUpdate(
    const UpdateInfo &_info,
    EntityComponentManager &_ecm)
{
  GZ_PROFILE("CustomMulticopterVelocityControl::PreUpdate");
...
//////////////////////////////////////////////////
void CustomMulticopterVelocityControl::OnTwist(
...
//////////////////////////////////////////////////
void CustomMulticopterVelocityControl::OnEnable(
...
//////////////////////////////////////////////////
void CustomMulticopterVelocityControl::PublishRotorVelocities(
    EntityComponentManager &_ecm,
...
GZ_ADD_PLUGIN(CustomMulticopterVelocityControl,
                    System,
                    CustomMulticopterVelocityControl::ISystemConfigure,
                    CustomMulticopterVelocityControl::ISystemPreUpdate)

GZ_ADD_PLUGIN_ALIAS(
    CustomMulticopterVelocityControl,
    "gz::sim::systems::CustomMulticopterVelocityControl")