 ...
 *
 */
#ifndef GZ_SIM_SYSTEMS_CUSTOMMULTICOPTERVELOCITYCONTROL_HH_
#define GZ_SIM_SYSTEMS_CUSTOMMULTICOPTERVELOCITYCONTROL_HH_
...
namespace systems
{
  ...
  /// system on each rotor. Note also that only one CustomMulticopterVelocityControl
  ...
  ///
  class CustomMulticopterVelocityControl
      : public System,
        public ISystemConfigure,
        public ISystemPreUpdate
  {
    /// \brief Constructor
    public: CustomMulticopterVelocityControl() = default;
